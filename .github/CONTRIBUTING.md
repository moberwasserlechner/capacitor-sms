...
GitHub issues are the source of truth for planned work. Search open and closed issues before creating a report, then use the relevant issue form and provide a minimal reproduction where possible.
...
- Update `README.md` when consumer guidance changes.
